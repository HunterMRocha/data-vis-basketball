function add_shot(year) {
    ...
    d3.csv('data/kobe.csv', data => {
        ...
        if (select_type == 'All shots') { var data = data } else if (select_type == 'Made') { var data = data.filter(d => d.shot_made_flag == 1) } else { var data = data.filter(d => d.shot_made_flag == 0) }
